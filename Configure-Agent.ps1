...
Process {
  ...
  Install-Component -Component $Software.vsts -Arguments "--unattended --url https://dev.azure.com/$TeamAccount --auth pat --token $PATToken --pool ""$PoolName"" --agent $ENV:COMPUTERNAME --work D:\agent_work --runAsService --windowsLogonAccount ""NT AUTHORITY\SYSTEM"""
